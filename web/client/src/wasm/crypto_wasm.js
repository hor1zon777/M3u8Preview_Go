...
export class EncryptResult {
    ...
    get clientPub() {
        ...
        try {
            ...
            wasm.encryptresult_clientPub(retptr, this.__wbg_ptr);
    ...
    get ct() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.encryptresult_ct(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    get iv() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.encryptresult_iv(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
if (Symbol.dispose) EncryptResult.prototype[Symbol.dispose] = EncryptResult.prototype.free;
...
export function encrypt_auth_payload(aad, server_pub_b64, challenge_b64, fingerprint_hex, plaintext_json) {
    try {
        ...
        const ptr1 = passStringToWasm0(server_pub_b64, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
        ...
        return EncryptResult.__wrap(r0);
    } finally {
        wasm.__wbindgen_add_to_stack_pointer(16);
    }
}
